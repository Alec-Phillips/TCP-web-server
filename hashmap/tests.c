...
int testPutGet() {
    ...
    testObj->val = 5;
    put(map, "fp1", testObj, 1);
    put(map, "fp2", testObj, 1);
    put(map, "fp3", testObj, 1);
    put(map, "fp4", testObj, 1);
    put(map, "fp5", testObj, 1);
    put(map, "fp6", testObj, 1);
    put(map, "fp7", testObj, 1);
    put(map, "fp8", testObj, 1);
    put(map, "fp9", testObj, 1);
    put(map, "fp10", testObj, 1);
    put(map, "fp11", testObj, 1);
    put(map, "fp12", testObj, 1);
    put(map, "fp13", testObj, 1);
    put(map, "fp14", testObj, 1);
    put(map, "fp15", testObj, 1);
    put(map, "fp16", testObj, 1);
    put(map, "fp17", testObj, 1);
...
int testPutRepeat() {
    ...
    testObj->val = 5;
    int putStatus;
    putStatus = put(map, "file path", testObj, 1);
    assert (putStatus == 0);
    putStatus = put(map, "file path", testObj, 1);
    assert (putStatus == 1);
